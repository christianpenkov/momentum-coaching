...
/* ⚠️ Il n'y a PAS de levier d'apparence ici, et c'est délibéré.
 *
 * Trois ont existé le temps d'une revue le 2026-09-01 — lissage ou segments droits,
 * densité de la grille, points sur chaque valeur — pour montrer les variantes côte à
 * côte en taille réelle. Chris a tranché (lissage monotone, grille à cinq traits, pas
 * de points), et ils ont été retirés le jour même.
 *
 * Ne pas les rouvrir « au cas où ». Un levier que personne ne bascule est une
 * combinaison de plus à tenir et à tester, pour une variante que plus personne ne
 * regarde. Si une variante redevient utile, elle se remontre en dix minutes dans une
 * fiche de revue — c'est comme ça que celle-ci a été tranchée. */
