...
export default function LoginPage() {
  ...
  async function handleLogin(e: React.FormEvent) {
    ...
    // Couvrir tout l'écran immédiatement
    setCovered(true);

    // Stocker les coords du bouton pour l'animation dans PageTransition
    ...
    // Naviguer après 1 frame pour que l'overlay soit peint
  ...
  return (
    <>
      {/* Overlay qui couvre tout dès la validation — masque le changement d'écran */}
      {covered && (
        <div style={{
          position: 'fixed', inset: 0, zIndex: 9999,
          background: '#1a1815', pointerEvents: 'none',
        }} />
      )}
        ...
        <div style={{
          ...
          {mode === 'login' ? (
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              ...
              <button ref={submitRef} type="submit" disabled={loading} className="btn-primary"
