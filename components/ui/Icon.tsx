...
const icons = {
  ...
  diamond: (
    <path d="M2.7 7.5L12 2l9.3 5.5v9L12 22l-9.3-5.5v-9z" />
  ),
  alert: (
    <>
  ...
  // Panneau d'attention triangulaire — distinct de `alert` (cercle) pour signaler
  // une action en attente plutôt qu'une information.
  'alert-triangle': (
    <>
  ...
  pin: (
    <path d="M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z M12 10m-3 0a3 3 0 106 0 3 3 0 00-6 0" />
  ),
  plus: (
    <>
  ...
  stripe: (
    <>
      <rect x="2" y="2" width="20" height="20" rx="4" fill="none" strokeWidth="1.5" />
      <path d="M11.5 9c0-.8.7-1.1 1.8-1.1 1.6 0 3.7.5 5.2 1.4V6.1C17 5.4 15.4 5 13.3 5 9.8 5 7.5 6.8 7.5 9.2c0 4.5 6.2 3.8 6.2 5.7 0 .9-.8 1.2-2 1.2-1.7 0-3.9-.7-5.6-1.7v3.3c1.6.7 3.2 1 5.6 1C15.3 18.7 18 17 18 14.5c0-4.8-6.5-4-6.5-5.5z" fill="currentColor" stroke="none" />
    </>
  ),
  brain: (
    <>
      <path d="M9.5 2A2.5 2.5 0 017 4.5v0A2.5 2.5 0 014.5 7v0A2.5 2.5 0 012 9.5v5A2.5 2.5 0 004.5 17v0A2.5 2.5 0 007 19.5v0A2.5 2.5 0 009.5 22h5a2.5 2.5 0 002.5-2.5v0A2.5 2.5 0 0019.5 17v0A2.5 2.5 0 0022 14.5v-5A2.5 2.5 0 0019.5 7v0A2.5 2.5 0 0017 4.5v0A2.5 2.5 0 0014.5 2h-5z" />
  ...
  'phone-call': (
    <>
      <path d="M15.05 5A5 5 0 0119 8.95M15.05 1A9 9 0 0123 8.94m-1 7.98v3a2 2 0 01-2.18 2 19.79 19.79 0 01-8.63-3.07A19.5 19.5 0 013.07 9.72 19.79 19.79 0 011 1.1 2 2 0 013 1h3a2 2 0 012 1.72c.127.96.361 1.903.7 2.81a2 2 0 01-.45 2.11L7.09 8.9a16 16 0 006 6l1.27-1.27a2 2 0 012.11-.45c.907.339 1.85.573 2.81.7A2 2 0 0121 16.92z" />
    </>
  ),
  eye: (
    <>
  ...
  // Logo Google Tasks : cercle en contour avec une ouverture, check qui dépasse
  // légèrement en haut à droite — recoordonné en 24x24 depuis le SVG source (192x192).
  'task-check': (
    <>
      <path d="M16.9 4.16a9.25 9.25 0 1 0 4.33 7.2" />
