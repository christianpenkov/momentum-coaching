...
function MessageContextMenu({ rect, html, canEdit, canDelete, onEdit, onDelete, onClose }: {
  ...
  // Le calcul tient compte de la hauteur réelle du clone une fois scale(BUBBLE_SCALE)
  // appliqué, pas de la taille d'origine — sinon le menu chevaucherait le clone agrandi.
  const GAP = 8;
